...
const chartConfig = {
  ...
  'guide': {
      ...
      'grid': { 'h_line': { 'visible': true, 'line_width': 0 }, 'v_line': { 'visible': false, 'line_width': 0 } },
  },
  'handle': {
      'popover': {
          'outset': { 'blur': 0 },
  ...
  'default_theme': {
      'data': {
          ...
          'bubble': { 'color': 'rgba(0,0,0,0.3)', 'border': 'rgba(255,255,255,0.3)' },
      },
      'graph': {
          'max': 'transparent',
          'min': 'transparent',
      ...
      'background': { 'color': 'rgba(24,33,47,1)', 'border': 'transparent', 'outset': 'transparent' },
      'title': { 'color': 'transparent', 'border': 'transparent' },
      'unit': { 'color': 'transparent', 'border': 'transparent' },
      'legend': { 'label': { 'border': 'transparent', 'color': 'transparent' }, 'border': 'transparent' },
      'guide': {
          'grid': { 'v_line': 'rgba(255,255,255,0.1)', 'h_line': 'rgba(255,255,255,0.1)' },
          'xaxis': {
      ...
      'handle': { 'popover': { 'color': 'rgba(0,0,0,0.8)', 'border': 'transparent', 'outset': 'transparent' } },
